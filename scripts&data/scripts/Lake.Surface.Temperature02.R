...
## Temperature ####
dat <- nc_open("/Volumes/MNPostDoc/LakeTemperatureData/LakeTemperature/Data/02_predicted_temp_N40-53_W67-98.nc")
...
saveRDS(data.final, "data/Lake.Surface.Temperature02.rds")
