#'---
#' title: "Size and Temps in Big Midwestern Fish Dataset"
...
#' 
#' This script will read in the data from Big Midwestern Fish Dataset, link it to lake thermal data, and analyze the relationship between size and lake temperature.
#' 
...
#' 
#' Follow on questions: 
#' Where does the variation in AL relationships arise? is it at the year level within lakes?
#' If so, then ALK only is required, but if not, then the estimated ages data could borrow across years (sensu HALK)
#'   
#' 
